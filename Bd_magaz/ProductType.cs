...
namespace Bd_magaz
{
    public partial class ProductType : Form
    {
        ...
        public ProductType(string connStr)
        {
            InitializeComponent();
            connString = connStr;
        }
        ...
        public DataTable loadInTable()
        {
            ...
            connection.Open();
            string sqlcmdString = "SELECT product_type.id_product_type AS 'ID', product_type.type AS 'Тип' FROM product_type ORDER BY product_type.id_product_type";
        ...
        private void searchTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)13)
            {
                ...
                try
                {
                    ...
                    MySqlConnection connection = new MySqlConnection(connString);
                    connection.Open();
                    string sqlcmdString = $"SELECT product_type.id_product_type AS 'ID', product_type.type AS 'Тип' FROM product_type WHERE LOCATE('{query}', product_type.type) ORDER BY product_type.id_product_type";
                    MySqlDataAdapter adapter = new MySqlDataAdapter(sqlcmdString, connection);
        ...
        private void dataGridView1_CellMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
                ...
                if (selectedRowCount > 0)
                {
                    ...
                    MySqlConnection connection = new MySqlConnection(connString);
                    connection.Open();
                    string sqlcmdString = $"SELECT * FROM product_type WHERE product_type.id_product_type = {selectedID}";
        ...
        private void createBTN_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlConnection connection = new MySqlConnection(connString);
                connection.Open();
                string sqlcmdString = $"INSERT INTO product_type (id_product_type, type) VALUES (NULL, '{obj[1]}')";
                MySqlCommand sqlcmd = new MySqlCommand(sqlcmdString, connection);
        ...
        private void chBTN_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlConnection connection = new MySqlConnection(connString);
                connection.Open();
                string sqlcmdString = $"UPDATE product_type SET id_product_type = '{obj[0]}', type = '{obj[1]}' WHERE product_type.id_product_type = {selectedID};";
                MySqlCommand sqlcmd = new MySqlCommand(sqlcmdString, connection);
                sqlcmd.ExecuteNonQuery();
                connection.Close();
        ...
        private void delBTN_Click(object sender, EventArgs e)
        {
            try
            {
                MySqlConnection connection = new MySqlConnection(connString);
                connection.Open();
                string sqlcmdString = $"DELETE FROM product_type WHERE product_type.id_product_type = {selectedID}";
                MySqlCommand sqlcmd = new MySqlCommand(sqlcmdString, connection);
                sqlcmd.ExecuteNonQuery();
                connection.Close();
